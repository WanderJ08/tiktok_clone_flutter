...
class _FollowingScreenState extends State<FollowingScreen> {
  ...
  getFollowingListKeys() async {
    //get the list of following keys
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Column(
          children: [
            Text(
              controllerProfile.userMap["userName"].toString(),
            ...
            Text(
              "Following " +
                  controllerProfile.userMap["totalFollowings"].toString(),
              style: const TextStyle(
                    ...
                    child: InkWell(
                      ...
                      child: ListTile(
                        ...
                        trailing: IconButton(
                            onPressed: () {
                              Get.to(ProfileScreen(
                                visitUserID: followingUsersDataList[index]
                                    ["uid"],
                              ));
                            },
                            icon: const Icon(
